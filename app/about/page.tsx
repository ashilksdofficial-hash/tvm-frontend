...
const VALUES = [
  ...
  { icon: "⚡", title: "Speed is Everything", desc: "We built our entire operation around speed. 45-60 minutes from order to door. We dispatch the moment you confirm." },
  ...
  { icon: "📍", title: "Mumbai First", desc: "We are a Mumbai-first service. We know every neighbourhood, every lane. Built for Mumbaians, by Mumbaians." },
        ...
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            {[
              ...
              { step: "04", title: "Delivered in 45-60 Mins", desc: "Your order arrives in plain, discreet packaging. Pay on delivery or UPI." },
            ].map((s, i) => (
        ...
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              ...
              "We have served 1,000+ customers across Mumbai with zero complaints about product authenticity",
      ...
      <section style={{ background: "var(--black)", padding: "80px 0" }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: 32, maxWidth: 480, margin: "0 auto 32px" }}>
            Join 1,000+ happy customers across Mumbai. Order now and get your vape in 45-60 minutes.
          </p>
