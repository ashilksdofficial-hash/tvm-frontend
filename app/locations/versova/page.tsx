    ...
    <div>
      ...
      <div style={{padding:"40px 20px"}}>
        ...
        <div style={{background:"#0D0D0D",borderRadius:14,padding:28,textAlign:"center"}}>
          <h3 style={{color:"#fff",marginBottom:8,fontFamily:"Inter,sans-serif"}}>Now Delivering to Versova</h3>
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "Do you deliver vapes to Versova Mumbai?", "acceptedAnswer": { "@type": "Answer", "text": "Yes! We deliver vapes to Versova Mumbai in 45-60 minutes. 100% original products." } }, { "@type": "Question", "name": "How to order vapes in Versova Mumbai?", "acceptedAnswer": { "@type": "Answer", "text": "WhatsApp us your order and Versova address. We confirm and dispatch immediately." } }] }) }} />
    </>
  );
}
