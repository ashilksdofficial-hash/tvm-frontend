  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container">
          <div style={{background:"#EFF6FF",border:"1px solid #BFDBFE",borderRadius:12,padding:16,marginBottom:32,fontSize:"0.85rem",color:"#1D4ED8"}}>
            Note: Pod systems need e-liquid separately. Message us for recommendations.
          </div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:16}}>
              <div key="Caliburn A2" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"BEGINNER"</span>
                  <Image src="/products/caliburn-a2.webp" alt="Caliburn A2" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn A2</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>520mAh · 15W</div>
              ...
              <div key="Caliburn G3 Lite" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"BUDGET"</span>
                  <Image src="/products/caliburn-g3-lite.webp" alt="Caliburn G3 Lite" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G3 Lite</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · 25W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G3 Lite KOKO" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"KOKO"</span>
                  <Image src="/products/caliburn-g3-lite-koko.webp" alt="Caliburn G3 Lite KOKO" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G3 Lite KOKO</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · 25W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G3 Pro" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"BEST"</span>
                  <Image src="/products/caliburn-g3-pro.webp" alt="Caliburn G3 Pro" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G3 Pro</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1000mAh · 35W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G3 Pro KOKO" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"KOKO"</span>
                  <Image src="/products/caliburn-g3-pro-koko.webp" alt="Caliburn G3 Pro KOKO" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G3 Pro KOKO</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1250mAh · 35W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G4" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"PREMIUM"</span>
                  <Image src="/products/caliburn-g4.webp" alt="Caliburn G4" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G4</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1500mAh · 40W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G4 Mini" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"MINI"</span>
                  <Image src="/products/caliburn-g4-mini.webp" alt="Caliburn G4 Mini" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G4 Mini</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>Compact · 40W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G4 Pro" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"PRO"</span>
                  <Image src="/products/caliburn-g4-pro.webp" alt="Caliburn G4 Pro" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G4 Pro</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1800mAh · 40W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G4 Pro KOKO" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"KOKO PRO"</span>
                  <Image src="/products/caliburn-g4-pro-koko.webp" alt="Caliburn G4 Pro KOKO" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G4 Pro KOKO</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1800mAh · KOKO</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G5 Lite" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"NEW"</span>
                  <Image src="/products/caliburn-g5-lite.webp" alt="Caliburn G5 Lite" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G5 Lite</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · 25W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G5 Lite SE" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"SPECIAL ED"</span>
                  <Image src="/products/caliburn-g5-lite-se.webp" alt="Caliburn G5 Lite SE" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G5 Lite SE</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · SE</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn G5 Lite KOKO" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"KOKO"</span>
                  <Image src="/products/caliburn-g5-lite-koko.webp" alt="Caliburn G5 Lite KOKO" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn G5 Lite KOKO</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · KOKO</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn GK2" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"NEW"</span>
                  <Image src="/products/caliburn-gk2.webp" alt="Caliburn GK2" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn GK2</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>690mAh · 18W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn Xpod" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"DISPLAY"</span>
                  <Image src="/products/caliburn-xpod.webp" alt="Caliburn Xpod" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn Xpod</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>1000mAh · 35W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
              ...
              <div key="Caliburn KOKO GK3" style={{background:"#fff",border:"1px solid #E5E7EB",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 12px rgba(0,0,0,0.06)"}}>
                <div style={{background:"#F9F9F9",position:"relative",aspectRatio:"1",overflow:"hidden"}}>
                  <span style={{position:"absolute",top:8,left:8,zIndex:1,background:"#2563EB",color:"#fff",fontSize:"0.6rem",fontWeight:700,padding:"3px 7px",borderRadius:100}}>"KOKO"</span>
                  <Image src="/products/caliburn-koko.webp" alt="Caliburn KOKO GK3" fill style={{objectFit:"contain",padding:"8px"}} sizes="50vw" />
                </div>
                <div style={{padding:12}}>
                  <div style={{fontSize:"0.82rem",fontWeight:700,color:"#0D0D0D",marginBottom:2,lineHeight:1.3}}>Caliburn KOKO GK3</div>
                  <div style={{fontSize:'0.7rem',color:'#6B7280',marginBottom:6}}>900mAh · 25W</div>
                  <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
                    <span style={{fontSize:"1rem",fontWeight:800,color:"#2563EB"}}>₹4,899</span>
                    <span style={{fontSize:"0.7rem",color:"#9CA3AF",textDecoration:"line-through"}}>₹6,123</span>
