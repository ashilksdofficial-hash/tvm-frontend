...
export const metadata: Metadata = {
  title: "Caliburn Pod System in Bangalore — Which One to Buy? | TheVapesInBangalore.in",
  description: "Complete guide to all Caliburn pod systems available in Bangalore. Prices, specs and which Caliburn is right for you. Fast delivery across Bangalore.",
  alternates: { canonical: "https://thevapesinbangalore.in/blog/caliburn-pod-system-bangalore" },
};
    ...
    <article>
      <section style={{background:"var(--black)",padding:"60px 0 40px"}}>
        <div className="container" style={{maxWidth:800}}>
          ...
          <h1 style={{color:"#fff"}}>Caliburn Pod System in Bangalore — Which One to Buy?</h1>
      ...
      <section className="section">
        <div className="container" style={{maxWidth:800}}>
          <p style={{fontSize:"1.05rem",color:"var(--gray)",marginBottom:32}}>Caliburn by Uwell is the most trusted pod system brand in Bangalore. Known for exceptional flavour, reliability, and build quality, Caliburn devices are the preferred choice for vapers who want a reusable pod system.</p>
          <h2 style={{marginBottom:24}}>All Caliburn Models Available in Bangalore</h2>
          ...
          <div style={{background:"var(--black)",borderRadius:12,padding:32,textAlign:"center"}}>
            <h3 style={{color:"#fff",marginBottom:8}}>Order Caliburn in Bangalore</h3>
            <p style={{color:"rgba(255,255,255,0.6)",marginBottom:24,fontSize:"0.9rem"}}>All Caliburn models available. 30-45 min delivery across Bangalore.</p>
